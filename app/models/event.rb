class Event < ActiveRecord::Base
  attr_accessible :booked_by, :booked, :created_by, :description, :disabled, :event_type_id, :from_date_time, :to_date_time, :updated_by
  ...
  # Validations
  validates_presence_of  :from_date_time, :to_date_time, :event_type_id, :booked_by, :booked, :description,:created_by, :updated_by
  ...
  def validate_from_date_time_and_to_date_time
    ...
    return self.errors.add(:base, "To date time should be on same date as on From date time.") unless self.from_date_time.to_date == self.to_date_time.to_date
